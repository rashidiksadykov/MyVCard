<template>
  <div class="flex flex-col items-center justify-center min-h-screen bg-gray-100">
    <h1 class="text-3xl font-bold mb-6">Просмотр сохранённых данных</h1>
    ...
    <div v-else-if="Object.keys(data).length === 0" class="text-gray-700">
      <p>Данные не найдены. Пожалуйста, сохраните их на предыдущей странице.</p>
    </div>
...
<style>
/* Стили для более приятного отображения */
</style>
